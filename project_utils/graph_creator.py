...
def create_graph_from_file(file_path: str):
    ...
    for _, row in df.iterrows():
        ...
        # Add HTTP request edge if present
        ...
        # Add SSL subject edge if present
        ...
        # Add SSL issuer edge if present
        ...
        # Add protocol violation edge if present
